...
public final class GraphicsSettings {
    ...
    private static final String SOFTNESS_KEY = PREFIX + "shadowSoftnessLength";

    private static final int DEFAULT_RAYS = 16;
    private static final float DEFAULT_NORMAL_STRENGTH = 0.5f;
    private static final float DEFAULT_SOFTNESS_LENGTH = 2.5f;
    ...
    private float shadowSoftnessLength = DEFAULT_SOFTNESS_LENGTH;
    ...
    public static GraphicsSettings load(final Properties props) {
        ...
        gs.softShadowsEnabled = Boolean.parseBoolean(props.getProperty(SOFT_SHADOW_KEY, "true"));
        gs.shadowSoftnessLength = Float.parseFloat(props.getProperty(SOFTNESS_KEY,
                Float.toString(DEFAULT_SOFTNESS_LENGTH)));
        return gs;
    }
    ...
    public void save(final Properties props) {
        ...
        props.setProperty(SOFTNESS_KEY, Float.toString(shadowSoftnessLength));
    }
}
